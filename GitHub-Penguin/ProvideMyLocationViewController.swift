...
class ProvideMyLocationViewController: UIViewController, CLLocationManagerDelegate {

    
    @IBOutlet weak var provide_myLocation_Map: MKMapView!
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]){
        ...
        if mapShouldBeCentered == true || spanCount == 0 {
            ...
            provide_myLocation_Map.setRegion(region, animated: true)
